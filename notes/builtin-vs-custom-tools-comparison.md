...
DeepAgents framework menyediakan **built-in filesystem tools** yang terintegrasi penuh dengan LangGraph state management. Tools ini menggunakan **BackendProtocol** sebagai interface standard untuk filesystem operations, menghindari reinventing the wheel.
